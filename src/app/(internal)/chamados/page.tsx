...
export default async function ChamadosPage({
  ...
  let query: any = supabase
    .from('tickets')
    .select('id, number, title, status, priority, channel, created_at, updated_at, sla_starts_at, sla_deadline, sla_first_response_at, sla_met, sla_paused_at, scheduled_at, companies(name), contacts(full_name), profiles!assigned_to(full_name)', { count: 'exact' })
